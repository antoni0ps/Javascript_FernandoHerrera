...
nuevaLongitud = juegos.unshift("Star Fox"); //unshift para añadir elemento al principio del array (star-fox)
console.log({ nuevaLongitud }, { juegos });

let juegoBorrado = juegos.pop(); // pop para borrar el ultimo elemento del array (F-Zero)
...
console.log({ ZeldaIndex: zeldaIndex });